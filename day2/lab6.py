# you live 4 miles from the university.The bus drives at 25mph but spends 2 minutes at each of the 10 stops on the way.
...
# since the bus spend two minutes in each ten steps so 2*10
t2 = 20
total1 = t1 + t2
...
print(f"the total time for jogging is {total_time2}")
if total_time2>total1:
    print(f"joggimg is fast to reach the university")
else:
